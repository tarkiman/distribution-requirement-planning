                ...
                <div class="box-body">
                  <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo base_url('index.php').'/karyawan/insert';?>">
                    ...
                    <div class="form-group has-success">
                      ...
                      <input type="text" name="nama_karyawan" class="form-control" placeholder="Masukan Nama Lengkap" required/>
                    </div>
                    <div class="form-group has-success">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-7">
                          <div class="input-group">
                              ...
                              <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir" readonly>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group"><div class="form-group has-success">
                      ...
                      <textarea name="alamat" class="form-control" rows="3" placeholder="Alamat Karyawan"></textarea>
                    </div>
                    <div class="form-group has-success">
